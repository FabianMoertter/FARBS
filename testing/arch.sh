...
#It's not officially part of FARBS, but I use it for testing.
...
curl https://raw.githubusercontent.com/FabianMoertter/FARBS/master/testing/chroot.sh > /mnt/chroot.sh && arch-chroot /mnt bash chroot.sh && rm /mnt/chroot.sh
